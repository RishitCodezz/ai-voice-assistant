...
See `LICENSE` if present. Otherwise, this repo has no license specified.

---

If you want a different README text (shorter, in Hindi, or more detailed developer setup), tell me what tone and I'll update it.
